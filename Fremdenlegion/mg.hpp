...
for "_i" from 1 to 2 do {player addItemToVest "R3F_100Rnd_762x51_MINIMI";};
player addBackpack "R3F_sac_moyen_CE";
player addItemToBackpack "R3F_casque_spectra";
for "_i" from 1 to 3 do {player addItemToBackpack "R3F_100Rnd_762x51_MINIMI";};
player addHeadgear "R3F_beret_para";

player addWeapon "R3F_Minimi_762";
